...
func (c *Caches) Sweep(threshold float64) {
	...
	c.DB.QuoteOfIDs.Trim(threshold)
	...
	c.DB.RelayMatcher.Trim(threshold)
	c.DB.RelayPush.Trim(threshold)
	c.DB.RelayPushIDs.Trim(threshold)
	c.DB.RelaySubscription.Trim(threshold)
